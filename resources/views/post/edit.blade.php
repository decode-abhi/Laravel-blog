...
<body>
    ...
    <div class="form-container">
        <form action="{{route('post.update',$post->id)}}" method="post">
            @csrf
            <input type="text" name="title" id="title" placeholder="enter your title for post" value="{{$post->title}}">
            <textarea name="body" id="body" cols="30" rows="30" placeholder="enter the content">{{$post->body}}</textarea>
